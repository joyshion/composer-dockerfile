...
RUN apk add --no-cache git php7 php7-openssl php7-gd php7-json php7-phar php7-iconv php7-mbstring php7-dom php7-fileinfo php7-tokenizer php7-xml php7-xmlwriter php7-xmlreader php7-ctype php7-mcrypt php7-pdo php7-pdo_mysql\
